...
namespace Pharmacy.Infrastructure.Migrations
{
    ...
    [Migration("20190606170132_AddFirstUser")]
            ...
            modelBuilder.Entity("Pharmacy.Core.Models.PrescriptionElement", b =>
                {
                    ...
                    b.HasKey("EanCode", "PrescriptionId");
            ...
            modelBuilder.Entity("Pharmacy.Core.Models.User", b =>
                {
                    ...
                    b.HasData(
                        new { Id = new Guid("681eab59-b691-4473-8e1f-89b15e869595"), CreatedAt = new DateTime(2019, 6, 6, 17, 1, 31, 905, DateTimeKind.Utc), Education = "Lekarz psychiatra", Email = "zdzislaw.grzybowski@gmail.com", FullName = "Zdzisław Grzybowski", IsActive = true, Password = "QGKV1MlHvDF8wLwq420gaGOUaIbr7xMcmDljIKyIdf9Piaa4XRzWVA==", Role = "Admin", Salt = "4FcMvFItucMRCKri01i9zks2bFEHqek4iCii64u/atgZgvuBk2N8JQ==", UpdatedAt = new DateTime(2019, 6, 6, 17, 1, 31, 905, DateTimeKind.Utc), Username = "zdzislaw.grzybowski@gmail.com" }
                    );
                });
